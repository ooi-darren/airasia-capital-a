...
**1. The crisis is concentrated in the airline, not the wider ecosystem.** Side by side on the most recent comparable quarter, the airline's EBITDA fell 56% year-on-year into a net operating loss, while none of Capital A's five retained businesses came close: two (ADE, Teleport) improved, three (AirAsia MOVE, AirAsia Next, Santan) softened only modestly (Notebook 13).
...
**6. Two of Capital A's five retained businesses grew and became more profitable in the same period.** ADE grew revenue 7.4% and EBITDA 7%; Teleport grew revenue 20%, with a currency-driven, not fundamental, EBITDA dip (Notebooks 8-9).
...
**DATA:** The airline's 2Q26 EBITDA fell 56% year-on-year into a net operating loss; in the same period, ADE grew EBITDA 7% and Teleport's core NOP grew from RM0.4m to RM3.1m, while AirAsia MOVE, AirAsia Next, and Santan softened only modestly.
